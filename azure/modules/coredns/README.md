...
| <a name="input_disable_default_kube_dns"></a> [disable\_default\_kube\_dns](#input\_disable\_default\_kube\_dns) | Whether to scale down the default kube-dns deployment | `bool` | `true` | no |
