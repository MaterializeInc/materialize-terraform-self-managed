...
output "alloydb_instance_name" {
  ...
  value       = module.alloydb.instance_name
}

output "alloydb_private_ip" {
  description = "AlloyDB instance private IP"
  value       = module.alloydb.private_ip
}

output "alloydb_users" {
  description = "List of AlloyDB users with credentials"
  value       = module.alloydb.users
  sensitive   = true
}
