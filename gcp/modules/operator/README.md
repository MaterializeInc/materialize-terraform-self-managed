...
| [kubernetes_network_policy_v1.allow_all_egress](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/network_policy_v1) | resource |
...
| <a name="input_tolerations"></a> [tolerations](#input\_tolerations) | Tolerations for operator pods. | <pre>list(object({<br/>    key      = string<br/>    value    = optional(string)<br/>    operator = optional(string, "Equal")<br/>    effect   = string<br/>  }))</pre> | `[]` | no |
