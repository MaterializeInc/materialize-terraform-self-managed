...
def write_variables_file(file_path: Path, hcl_content: str) -> bool:
    """Write a Terraform variables file if content has changed.
    ...
    # Always write the file first, then format
...
def write_crd_variables_file(directory: Path, type_expr: str) -> bool:
    ...
    return write_variables_file(directory / "crd_variables.gen.tf", hcl_content)


def write_helm_variables_file(directory: Path, type_expr: str) -> bool:
    ...
    return write_variables_file(directory / "helm_variables.gen.tf", hcl_content)
...
def main():
    ...
    print(f"\nWriting {MATERIALIZE_INSTANCE_DIR / 'crd_variables.gen.tf'}...")
