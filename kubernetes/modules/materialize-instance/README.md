...
| Name | Type |
|------|------|
| [kubectl_manifest.materialize_instance](https://registry.terraform.io/providers/alekc/kubectl/2.2.0/docs/resources/manifest) | resource |
...
| <a name="input_environmentd_version"></a> [environmentd\_version](#input\_environmentd\_version) | Version of environmentd to use | `string` | `"v26.24.2"` | no |
