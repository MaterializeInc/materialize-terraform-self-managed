...
| <a name="input_ui_fqdn"></a> [ui\_fqdn](#input\_ui\_fqdn) | Fully-qualified domain name for the standalone Ory selfservice UI (e.g. id.example.com). Required when deploy\_selfservice\_ui is true, ignored otherwise. | `string` | `null` | no |
