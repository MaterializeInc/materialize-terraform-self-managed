...
| <a name="input_selfservice_ui_image_tag"></a> [selfservice\_ui\_image\_tag](#input\_selfservice\_ui\_image\_tag) | Tag for the OEL selfservice UI image pulled through the registry proxy. | `string` | `"v25.4.0"` | no |
