...
| <a name="input_selfservice_ui_image_tag"></a> [selfservice\_ui\_image\_tag](#input\_selfservice\_ui\_image\_tag) | Tag for the OEL selfservice UI image. Defaults to oel\_image\_tag when null, so it tracks the other OEL images unless overridden. | `string` | `null` | no |
