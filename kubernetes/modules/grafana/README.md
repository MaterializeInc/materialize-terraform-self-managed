...
| Name | Version |
| ---- | ------- |
| <a name="provider_helm"></a> [helm](#provider\_helm) | >= 2.5.0, < 3.3.0 |
...
| <a name="input_storage_class"></a> [storage\_class](#input\_storage\_class) | Storage class for Grafana persistent volume. If not specified, uses the cluster default storage class. | `string` | `null` | no |
