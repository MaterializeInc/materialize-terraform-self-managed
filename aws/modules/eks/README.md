...
| <a name="input_materialize_node_ingress_cidr"></a> [materialize\_node\_ingress\_cidr](#input\_materialize\_node\_ingress\_cidr) | List of CIDR blocks to allow ingress from for Materialize ports (HTTP 6876, pgwire 6875, health checks 8080) | `list(string)` | n/a | yes |
| <a name="input_materialize_node_ingress_ipv6_cidr"></a> [materialize\_node\_ingress\_ipv6\_cidr](#input\_materialize\_node\_ingress\_ipv6\_cidr) | List of IPv6 CIDR blocks to allow ingress from for Materialize ports (HTTP 6876, pgwire 6875, health checks 8080). Leave empty to disable IPv6 access. | `list(string)` | `[]` | no |
