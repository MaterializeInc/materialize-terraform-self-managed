...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | Prefix for the bucket and IAM role names this module creates. | `string` | n/a | yes |
